...
import { SectionSeparator } from '../../elements/SectionSeparator/SectionSeparator';
import { CustomForm } from '../../compartments/CustomForm/CustomForm';
...
export const SmartSection: React.FC<{
  ...
  const renderContent = (
    ...
    switch (sectionContent.contentType) {
      ...
      case 'form':
        return <CustomForm data={sectionContent} submitForm={() => {}} />;
      case 'contentlist':
